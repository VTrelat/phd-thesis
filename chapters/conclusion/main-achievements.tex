...
The automated route proves a semantic bridge before delegating search to an
SMT solver; the interactive route checks the final derivation in Lean. Neither
guarantee covers the complete toolchain, but each identifies what has been
established and what must still be trusted.
