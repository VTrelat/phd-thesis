...
\begin{definition}[][PSet.empty][Mathlib/SetTheory/ZFC/PSet.html\#PSet.empty]
  The empty pre-set is obtained from the (universe polymorphic) empty type \(\bot\) and its elimination function \(\displaystyle\mathsf{elim}_\bot : \prod_\alpha \bot \to \alpha\)
  \begin{equation*}
...
\begin{definition}[][ZFSet.π₁, ZFSet.π₂][ZFLean/Integers.html, ZFLean/Integers.html]
