...
We follow standard constructions\footnote{See, \eg K.\ Kunen's textbook~\cite[Ch.~1, Sec.~11]{kunen2011set}.} to build integers as equivalence classes of pairs of naturals under the relation $(a,b) \zrel (c,d) \iff a + d = b + c$ for all $a,b,c,d : \mathsf{ZFNat}$.
...
\begin{definition}[Ring of integers][ZFSet.ZFInt, ZFSet.Int][ZFLean/Integers.html\#ZFSet.ZFInt, ZFLean/Integers.html\#ZFSet.Int]
  ...
  We then define a set $\mathbb{Z}$ of canonical representatives of integers as the following union:
  \[
    \mathbb{Z} \triangleq \mathbb{N} \times \{0_{\mathbb{N}}\}\, \cup\, \{0_{\mathbb{N}}\} \times \mathbb{N}
  \]
  and prove that the subtype built from the extension of the set $\mathbb{Z}$ is isomorphic to $\mathsf{ZFInt}$ (which also provides coercions, \ie type-level conversions, between the two).
\end{definition}
