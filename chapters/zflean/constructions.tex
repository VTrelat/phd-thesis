...
We follow standard constructions---as in K.\ Kunen's textbook~\cite[Ch.~1, Sec.~11]{kunen2011set}---to build integers as equivalence classes of pairs of naturals under the relation $(a,b) \zrel (c,d) \iff a + d = b + c$ for all $a,b,c,d : \mathsf{ZFNat}$.
