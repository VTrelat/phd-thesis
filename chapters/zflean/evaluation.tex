...
\end{leanlisting}
  On the left-hand side we use that evaluating a composite is the composition of the evaluations---i.e.\ application distributes over composition---given by the following theorem \leancodeptr{fapply\_composition}{ZFLean/Functions.html\#ZFSet.fapply_composition}:
  \begin{leanlisting}
