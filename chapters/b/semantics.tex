...
The semantics of B developed in this work is \inlremark[\emph{denotational}]{reference} and is defined over the ZFLean framework developed in \Cref{ch:zflean}.
...
evaluated---compared to, say, an \inlremark[operational semantics]{reference}.
...
\inlremark[]{Add a proper conclusion to this chapter.}