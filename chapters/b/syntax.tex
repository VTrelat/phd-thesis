...
\begin{equation*}
  \lift{\intB} \triangleq \mathbb{Z},\quad
  \lift{\boolB} \triangleq \mathbb{B},\quad
...
\begin{align*}
  \mathsf{FIN}(A) &\triangleq \{\, S \inB \powB(A) \mid \existsB n \inB \mathbb{Z} \cdot \existsB f \inB S \injtfunB \mathbb{Z} \cdot \forallB x, y \inB S \prodB \mathbb{Z} \cdot \\
...
\begin{align*}
  \mathbb{N} &\triangleq \{\, n \inB \mathbb{Z} \mid \mathsf{int}\ 0 \leB \mathsf{int}\ n \,\}\\
  \intrangeB{i}{j} &\triangleq \{\, n \inB \mathbb{Z} \mid i \leB n \andB n \leB j \,\}\\
...
Let \(A\) be a B term, and let \(\tau\) be a B type.
\begin{align*}
  \mathsf{seq}(A) &\triangleq \{\, s \inB \mathbb{N} \pfunB A \mid \existsB n \inB \mathbb{Z} \cdot \existsB f \inB s \tfunB \intrangeB{\mathsf{int}\ 0}{n} \,\} \\
  \mathsf{seq}_1(A) &\triangleq \{\, s \inB \mathbb{N} \pfunB A \mid \left(\existsB n \inB \mathbb{Z} \cdot \existsB f \inB s \tfunB \intrangeB{\mathsf{int}\ 0}{n}\right) \andB\\
