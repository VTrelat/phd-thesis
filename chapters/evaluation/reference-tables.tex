...
\caption{Strict and verdict-only success per subject class, with the two
...
\caption{The construct classes of \Cref{fig:eval-construct} under both
  scorings, in the figure's order.}
...
\caption{Success by type order, under both scorings.}
