...
making the validity of a result depend on the opacity of the tool that proposed
it. \Cref{sec:intro-llm-use} provides a methodological account of how LLMs were
